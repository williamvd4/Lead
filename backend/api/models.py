...
class Size(models.Model):
    name = models.CharField(max_length=50, unique=True) # E.g., "Small", "Medium", "Large", "S", "M", "L"
    abbreviation = models.CharField(max_length=10, unique=True, blank=True, null=True) # E.g., "S", "M", "L"
...
class ShopItems(models.Model):
    # Removed CATEGORY_CHOICES as we are now using a ForeignKey to ShopCategory
    ...
    category = models.ForeignKey(ShopCategory, related_name='shop_items', on_delete=models.SET_NULL, null=True, blank=True)
...
@receiver(pre_save, sender=ShopItems)
def pre_save_shopitems_receiver(sender, instance, *args, **kwargs):
